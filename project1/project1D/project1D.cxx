...
void Triangle::print_triangle() {
  printf("Tri 0: x:%f, y:%f, R: %f, G: %f, B: %f\n", X[0], Y[0], colors[0].R, colors[0].G, colors[0].B);
  printf("Tri 1: x:%f, y:%f, R: %f, G: %f, B: %f\n", X[1], Y[1], colors[1].R, colors[1].G, colors[1].B);
  printf("Tri 2: x:%f, y:%f, R: %f, G: %f, B: %f\n", X[2], Y[2], colors[2].R, colors[2].G, colors[2].B);
}
...
class Screen
{
  public:
    ...
    void ImageColor(int r, int c, double z, Color color);
};

void Screen::ImageColor(int r, int c, double z, Color color) {
...
Triangle split_top(Triangle tri, int min, int med, int max) {
  ...
  // Lerp new color and Z for new point
